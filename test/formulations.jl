...
function example_assignment_automatic_dantzig_wolfe()
    nb_machines = 4
    nb_jobs = 30
...
function generalized_assignment_automatic_dantzig_wolfe(d::GapData)
    model = BlockModel(automatic_dantzig_wolfe = true)
